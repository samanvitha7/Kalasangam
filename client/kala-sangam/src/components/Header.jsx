    ...
    <header className="bg-gradient-to-r from-[#fdf6e3] via-[#fae5d3] to-[#ffe6eb] shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8 text-[#582f0e] font-medium text-lg items-center relative">
          ...
          {/* Explore Dropdown with Click Toggle */}
          <div className="relative" ref={dropdownRef}>
            ...
            {showDropdown && (
              <ul
                className="absolute top-full mt-2 bg-white text-[#582f0e] shadow-md rounded w-48 z-50
                  transition-all duration-200 transform scale-100 opacity-100"
              >
                <li
