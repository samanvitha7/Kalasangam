  ...
  return (
    <header
      className={`
        ...
        ${scrolled
          ? "bg-blush-peach/95 backdrop-blur-md rounded-full shadow-2xl px-4 sm:px-6 border border-vermilion/20"
    ...
    >
      <div className="flex items-center justify-between h-full w-full">
          ...
          >
            <img
              ...
              className={`
                ...
                ${scrolled 
                  ? "h-12 sm:h-16 md:h-20 scale-100 sm:scale-125" 
                  : "h-16 sm:h-20 md:h-24 scale-100 sm:scale-125 md:scale-150"}
                hover:scale-110 sm:hover:scale-150 md:hover:scale-[1.7]
              `}
            />
          </Link>
        </div>
        ...
        <nav className="hidden lg:flex items-center justify-center flex-1 text-[1.35rem] font-bold tracking-wide transition-colors duration-500 ease-in-out text-deep-teal">
          <div className="flex items-center justify-center space-x-8">
            ...
            <div className="relative flex items-center" ref={dropdownRef}>
              <span
                className={`font-winky font-[500] text-deep-teal cursor-pointer flex items-center transition-all duration-300 ease-in-out hover:text-rosehover ${
                  !scrolled ? "relative top-3" : ""
                }`}
        ...
        {/* Desktop User Profile/Auth - Hidden on mobile */}
        <div className={`hidden lg:flex items-center justify-end space-x-4 ${
          ...
          {isAuthenticated ? (
            ...
            <>
              <Link
                to="/login"
                className="px-5 py-2 rounded-full font-bold transition-all duration-300 bg-gradient-to-r from-deep-teal to-coral-red text-white hover:from-coral-red hover:to-saffronglow"
              >
                Login
              </Link>
              <Link
